    ...
    return (
        <Fragment> 
            ...
            <div className={styles['rollstarSlider__list']} ref={imageList}>
                <img src={home_page.slider_img1} alt="firstSliderImage" className={styles['rollstarSlider__item']}/>
                <img src={home_page.slider_img2} alt="secondSliderImage" className={styles['rollstarSlider__item']}/>
                <img src={home_page.slider_img3} alt="thirdSliderImage" className={styles['rollstarSlider__item']}/>
                <img src={home_page.slider_img4} alt="firstSliderImage" className={styles['rollstarSlider__item']}/>
                <img src={home_page.slider_img5} alt="secondSliderImage" className={styles['rollstarSlider__item']}/>
                <img src={home_page.slider_img6} alt="thirdSliderImage" className={styles['rollstarSlider__item']}/>
            </div>
